		...
		<>
			<div
				...
				<motion.div
					...
					<motion.div
						...
						<Image
							src={timemailImg}
							alt="TimeMail - Disposable Email Generator"
			...
			<div
				...
				<motion.div
					...
					className="w-full p-20 xm:p-7 sm:p-7 flex justify-between rounded-[30px] gap-10 relative -top-[45%] min-h-[800px] h-auto transform origin-top xm:flex-col sm:flex-col">
					<div className="w-1/2 xm:w-full sm:w-full h-full flex flex-col gap-6 pt-10 xm:pt-5 sm:pt-5 xm:gap-5 sm:gap-5">
						<div className="flex flex-col gap-2">
							<h4
								className="text-[24px] xm:text-lg sm:text-lg leading-tight tracking-tighter"
					...
					<motion.div
						...
						<Image
							src={whatwedoImg2}
							alt="PayPro Gateway - UPI Payment Link Generator"
							className="w-[80%] object-cover"
						/>
					</motion.div>
				</motion.div>
			...
			<div
				...
				<motion.div
					...
					className="w-full p-20 xm:p-7 sm:p-7 flex justify-between rounded-[30px] gap-10 relative -top-[45%] h-[800px] transform origin-top xm:flex-col sm:flex-col">
					<div className="w-1/2 xm:w-full sm:w-full h-full flex flex-col gap-6 pt-4 xm:pt-5 sm:pt-5 xm:gap-5 sm:gap-5">
						<div className="flex flex-col gap-2">
							<h4
								className="text-[24px] xm:text-lg sm:text-lg leading-tight tracking-tighter"
					...
					<motion.div
						...
						<Image
							src={whatwedoImg3}
							alt="PatternNix - Beautiful Background Patterns"
							className="w-[80%] object-cover"
						/>
					</motion.div>
				</motion.div>
			...
			<div
				...
				<motion.div
					...
					<motion.div
						...
						<Image
							src={whatwedoImg4}
							alt="Language Converter - Code Translation Tool"
							className="w-[80%] object-cover"
						/>
					</motion.div>
				</motion.div>
