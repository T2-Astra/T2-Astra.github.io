	...
	return (
		<div className="w-full min-h-screen flex flex-col items-center justify-center padding-x gap-10">
			<div
				...
				ref={containerRef}>
				<h1 className="text-[24px] xm:text-lg sm:text-lg text-[#9FE870] font-normal leading-tight tracking-tight text-center">
				...
				<span
					...
					ref={textRef}>
					{"Astra".split("").map((item: string, i: number) => (
						<motion.p
							initial={{ y: "100%" }}
							whileInView={{ y: 0 }}
							transition={{
